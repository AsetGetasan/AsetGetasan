...
import 'package:getasan_apps/features/lapor_kegiatan/detail/presentation/detail_lapor_kegiatan.dart';
import 'package:getasan_apps/features/lapor_kegiatan/tambah/presentation/tambah_lapor_kegiatan.dart';
import 'package:getasan_apps/features/profile/presentation/profile.dart';

const List<String> list = <String>['One', 'Two', 'Three', 'Four'];

class LaporKegiatanScreen extends StatelessWidget {
  LaporKegiatanScreen({super.key});
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return TambahLaporKegiatanScreen();
            }));
          },
          child: FaIcon(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Image.asset('assets/lapor_kegiatan_desa.png'),
                SizedBoxDimen().h20Gap,
                Text(
                  'Lapor Kegiatan Desa Anda ',
                  style: TextStyle(
                    fontSize: 24,
                    fontWeight: FontWeight.bold,
                ...
                // SizedBoxDimen().h20Gap,
                Text(
                  'Laporkan kejadian yang terjadi di Desa Anda',
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey,
                  ),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DetailLaporKegiatanDesa(),
                              ),
                            );
                          },
                          child: Text(
