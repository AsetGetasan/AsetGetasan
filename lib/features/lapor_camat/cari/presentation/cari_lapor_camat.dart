...
class LaporCamatScreen extends StatelessWidget {
  LaporCamatScreen({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Image.asset('assets/lapor_camat.png'),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DetailLaporCamatScreen(),
                              ),
                            );
                          },
                          child: Text(
