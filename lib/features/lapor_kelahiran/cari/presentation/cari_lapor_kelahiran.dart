...
import 'package:getasan_apps/features/lapor_kelahiran/detail/presentation/detail_lapor_kelahiran.dart';
...
class LaporKelahiranScreen extends StatelessWidget {
  LaporKelahiranScreen({super.key});
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return TambahLaporKelahiranScreen();
            }));
          },
          child: FaIcon(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Image.asset('assets/lapor_kelahiran.png'),
                ...
                // SizedBoxDimen().h20Gap,
                Text(
                  'Laporkan kelahiran yang terjadi di Desa Anda',
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey,
                  ),
